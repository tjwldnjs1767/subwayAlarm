...
import com.arlib.floatingsearchviewdemo.data.Suggestion;
import com.arlib.floatingsearchviewdemo.data.Wrapper;
    ...
    private void setupFloatingSearch() {
        ...
        mSearchView.setOnSearchListener(new FloatingSearchView.OnSearchListener() {
            ...
            public void onSuggestionClicked(final SearchSuggestion searchSuggestion) {
                ...
                DataHelper.findColors(getActivity(), suggestion.getBody(),
                        new DataHelper.OnFindColorsListener() {

                            @Override
                            public void onResults(List<Wrapper> results) {
                                mSearchResultsAdapter.swapData(results);
                            }

                        });
                Log.d(TAG, "onSuggestionClicked() " + mSearchView.getQuery());

                // TODO: 2017-05-10 최근 검색어 pref로 저장 
                searchHistory.add(mSearchView.getQuery());
